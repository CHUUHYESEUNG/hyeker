...
import { getPortfolioItem, updatePortfolioItem, PortfolioPlatform, PortfolioCategory, DevelopmentSubCategory, DesignSubCategory } from '@/lib/firebase/firestore'
    ...
    const fetchItem = async () => {
      try {
        ...
        setFormData({
          ...
          subCategory: item.subCategory || 'web',
          showPlatforms: item.showPlatforms ?? true,
          showDetailLink: item.showDetailLink ?? false,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold text-foreground">포트폴리오 수정</h2>
          <p className="text-muted-foreground mt-1">기존 포트폴리오 항목을 수정합니다</p>
        </div>
      </div>
